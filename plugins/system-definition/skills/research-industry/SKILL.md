...
description: >
  ...
  choices (use /architecture:design-architecture); deciding what to build first (use ../plan-system/SKILL.md).
license: MIT
...
- `/architecture:design-architecture` — later reads the *Compliance* section
