...
description: >
  ...
  DO NOT USE FOR: static config checks of workflow/settings files (use ../validate-system/SKILL.md);
...
- Static validation of workflow/settings config → use [`validate-system`](../validate-system/SKILL.md). A system that isn't statically valid isn't worth running.
