...
11. **Remind the user** that connector code-copy and Terraform scaffolding are NOT performed by this skill — they happen later when [`build-system`](../build-system/SKILL.md) runs over the project.
...
- [`build-system`](../build-system/SKILL.md) — when you're ready to turn the composed `workflow.json` into actual code.
