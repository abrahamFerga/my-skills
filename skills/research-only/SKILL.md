...
([skill](../research-industry/SKILL.md)) for the industry, writing
...
([skill](../synthesize-spec/SKILL.md)), writing `<target_path>/SPEC.md`.
Otherwise stop.
...
- [`../research-industry/SKILL.md`](../research-industry/SKILL.md), [`../synthesize-spec/SKILL.md`](../synthesize-spec/SKILL.md) — the phases this runs.
