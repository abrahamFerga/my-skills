...
description: >
  ...
  sits in the architecture (use ../dotnet-architecture/SKILL.md).
license: MIT
---
...
- **Deciding which layer the data code belongs in** → the [`dotnet-architecture`](../dotnet-architecture/SKILL.md) skill (EF Core lives in the Infrastructure layer behind a repository / `DbContext` abstraction).
...
- [`dotnet-architecture`](../dotnet-architecture/SKILL.md) — where EF Core sits in the Infrastructure layer
