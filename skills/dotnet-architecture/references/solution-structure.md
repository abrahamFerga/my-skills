...
> [`dotnet-aspire-base`](../../dotnet-aspire-base/SKILL.md).** Defer to it for the
...
[`dotnet-aspire-base`](../../dotnet-aspire-base/SKILL.md):
...
[`dotnet-aspire-base`](../../dotnet-aspire-base/SKILL.md) — or, for the standalone
...
See [`../aspire/SKILL.md`](../../aspire/SKILL.md). The two Aspire projects are part
...
See [`../entity-framework-core/SKILL.md`](../../entity-framework-core/SKILL.md).
