...
- [../dotnet-architecture/SKILL.md](../dotnet-architecture/SKILL.md) — the architecture-style decision (modular monolith / Clean Architecture / vertical slice), plus Terraform + GitHub Actions to ship this backbone to Azure. It defers to this skill for the concrete backbone and uses the same `Api` host name.
